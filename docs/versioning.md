...
For public release `v0.1.2.0`, workspace crates use Cargo version `0.1.2`. Bugfix releases keep the same public feature prefix and update the public bugfix component. If crates are published externally, decide per bugfix release whether the Cargo patch version also needs to move.

## Current Release Baseline

The current release baseline is:

- public release: `v0.1.2.0`
- Cargo workspace version: `0.1.2`
- Servo baseline: `0.1`
- Axion feature version: `2`

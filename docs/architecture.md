...
v0.1.6.0 completes the CI and diagnostics stabilization milestone on top of the frontend diagnostics, compatibility helpers, generated-app workflow, capability-gated native command surface, native dialog preview, executable-aware bundling, and multi-window diagnostics completed through v0.1.5.0. The release strengthens MSRV reporting, CI release gates, diagnostics report schema documentation, and CI artifact collection. Axion public versions use four components to separate Servo baseline, Axion feature milestones, and bugfix releases; Cargo crates keep SemVer-compatible three-component versions. Installer generation, signing, auto-updates, broader native API coverage, and CI GUI integration tests remain later milestones.
